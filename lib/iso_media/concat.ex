  ...
  def concat([first | _] = inputs) do
    ...
    bound =
      Layout.box_size(ftyp) +
        Layout.box_size(
          assemble_moov(first_moov, inputs_data, track_count, dummy.(), :co64, movie_ts)
        ) +
        16 + total
    ...
    moov_final =
      assemble_moov(first_moov, inputs_data, track_count, offsets_by_track, co_kind, movie_ts)
